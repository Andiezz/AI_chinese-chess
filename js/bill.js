...
bill.init = function (){
	if (com.store){
		...
		bill.setBillList(com.arr2Clone(com.initMap)); //write chess list
		play.isPlay=false;	
		com.show();
	}else {
